...
class PatientlistView extends GetView<PatientlistController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PatientlistController>(
      builder: (controller) {
        return PopScope(
            ...
            body: Stack(
              ...
              children: [
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              ...
                              controller.tempFloorsList = List.unmodifiable(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    keyboardDismissBehavior:
                                        ScrollViewKeyboardDismissBehavior
                                            .onDrag,
                                    physics: controller.filterPatientList !=
                                                null &&
                                            controller
                                                    .filterPatientList!.length <
                                                3
                                        ? const NeverScrollableScrollPhysics()
                                        : const BouncingScrollPhysics(),
                                    controller:
                                        controller.patientScrollController,
                                    padding: EdgeInsets.only(
                                        bottom: hideBottomBar.value
                                            ? Sizes.crossLength * 0.020
                                            : Sizes.crossLength * 0.120),
                                    itemCount:
                                        controller.filterPatientList!.length,
                ...
                controller.showShortButton &&
                    ...
                    ? Padding(
                        padding: EdgeInsets.only(
                            bottom: hideBottomBar.value ? 20 : 70),
                        child: Align(
                          alignment: Alignment.bottomCenter,
                          child: SizedBox(
                            height: 45,
