...
class CorporateListView extends StatelessWidget {
  const CorporateListView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<InsuranceCompaniesController>(builder: (controller) {
      return controller.corporateList.isEmpty
          ? Center(
              child: AppText(
                text: "No data found.",
                fontSize: Sizes.px15,
          ...
          : ListView.builder(
              itemCount: controller.corporateList.length,
              padding: const EdgeInsets.only(bottom: 20),
              controller: controller.corporateScrollController,
              shrinkWrap: true,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: AppText(
                                  text: controller.corporateList[index].name ??
                                      '',
                                  fontSize: Sizes.px14,
